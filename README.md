# GadgetMesh.bh — free e-commerce starter for Bahrain
...
2. In your repo, go to **Settings → Pages → Custom domain**, type your domain (e.g. `gadgetmesh.bh` or `www.gadgetmesh.bh`), and save. GitHub creates a `CNAME` file in your repo automatically — leave it there.
